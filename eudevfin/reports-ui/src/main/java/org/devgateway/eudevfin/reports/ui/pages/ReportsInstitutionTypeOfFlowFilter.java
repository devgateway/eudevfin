...
@MountPath(value = "/reportsinstitutiontypeofflowfilter")
public class ReportsInstitutionTypeOfFlowFilter extends CustomReportsPage {

    public ReportsInstitutionTypeOfFlowFilter () {
        Label title = new Label("title", new StringResourceModel("reportsInstitutionTypeOfFlowFilter", this, null, null));
        add(title);
