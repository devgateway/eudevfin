...
public class IatiXstreamTest {
	...
	public void testTransform() {
		...
		act1.setTitle(new StringWithLanguage("Title1"));
		act1.setDescription(new StringWithLanguage("Description 1"));
		...
		act2.setTitle(new StringWithLanguage("Title1"));
		act2.setDescription(new StringWithLanguage("Description 1"));
