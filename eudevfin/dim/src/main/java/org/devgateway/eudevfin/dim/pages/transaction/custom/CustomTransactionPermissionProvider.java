...
public class CustomTransactionPermissionProvider extends CRSTransactionPermissionProvider {
    ...
    protected HashMap<String, RoleActionMapping> initPermissions() {
        ...
        permissions.get("8channelDelivery").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE).notCollected(SB.NON_ODA_OOF_EXPORT);
        ...
        permissions.get("23tradeDevelopment").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("24freestandingTechnicalCooperation").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("25programmeBasedApproach").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("26investmentProject").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("27associatedFinancing").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("28biodiversity").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("29ccMitigation").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("30ccAdaptation").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("31desertification").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        //end override
        ...
        permissions.get("40amountOfExpertsCommitments").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("41amountOfExpertsExtended").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        permissions.get("42amountOfExportCredit").notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
        //end override
         ...
         */
        //override permissions
        permissions.get(ForLoansOnlyTab.KEY).notCollected(SB.BILATERAL_ODA_ADVANCED_QUESTIONNAIRE).notCollected(SB.MULTILATERAL_ODA_ADVANCED_QUESTIONNAIRE);
