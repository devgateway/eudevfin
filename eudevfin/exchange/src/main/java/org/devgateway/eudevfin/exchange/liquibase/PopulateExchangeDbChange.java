...
public class PopulateExchangeDbChange extends AbstractSpringCustomTaskChange {
	...
	public void execute(Database database) throws CustomChangeException {
		...
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.EUR, CurrencyUnit.USD,
				...
				ExchangeRateConstants.EXCHANGE_RATE_ONLINE));
		...
		HistoricalExchangeRate historicalExchangeRate = HistoricalExchangeRate.of(CurrencyUnit.EUR, CurrencyUnit.USD,
				invert(0.7192), LocalDateTime.parse("2011-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD);
		NullableWrapper<HistoricalExchangeRate> save = exchangeRateDaoImplEndpoint.save(historicalExchangeRate);
		
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.EUR, CurrencyUnit.USD,
				invert(0.778), LocalDateTime.parse("2012-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.EUR, CurrencyUnit.USD,
				invert(0.7532), LocalDateTime.parse("2013-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		...
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(PLN), CurrencyUnit.USD,
				invert(2.9621), LocalDateTime.parse("2011-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(PLN), CurrencyUnit.USD,
				invert(3.2518), LocalDateTime.parse("2012-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(PLN), CurrencyUnit.USD,
				invert(3.1596), LocalDateTime.parse("2013-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		...
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(HUF), CurrencyUnit.USD,
				invert(200.9068), LocalDateTime.parse("2011-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(HUF), CurrencyUnit.USD,
				invert(224.823), LocalDateTime.parse("2012-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(HUF), CurrencyUnit.USD,
				invert(223.5404), LocalDateTime.parse("2013-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));


		//CZK
		Currency CZK=Currency.getInstance("CZK");		
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(CZK), CurrencyUnit.USD,
				invert(17.6722), LocalDateTime.parse("2011-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(CZK), CurrencyUnit.USD,
				invert(17.6722), LocalDateTime.parse("2012-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(CZK), CurrencyUnit.USD,
				invert(17.6722), LocalDateTime.parse("2013-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		...
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(BGN), CurrencyUnit.USD,
				invert(1.4066), LocalDateTime.parse("2011-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(BGN), CurrencyUnit.USD,
				invert(1.523), LocalDateTime.parse("2012-06-06"),ExchangeRateConstants.EXCHANGE_RATE_OECD));
//		exchangeRateDaoImplEndpoint.save(HistoricalExchangeRate.of(CurrencyUnit.of(BGN), CurrencyUnit.USD,
