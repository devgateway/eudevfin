...
public class FinancialTransactionDaoImpl extends AbstractDaoImpl<FinancialTransaction, Long, FinancialTransactionRepository> {
    ...
    /**
     * @see
     * FinancialTransactionService#findByReportingYearAndTypeOfFlowCode(LocalDateTime,String)
     * @param reportingYear
     * @return
     */
    ...
    @Override
    protected FinancialTransactionRepository getRepo() {
        return this.repo;
    }

    /**
     * see
     * {@link FinancialTransactionService}{@link #findByCrsIdentificationNumber(String)}
     *
