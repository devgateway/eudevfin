...
public class CustomFinancialTransactionDao
    ...
    /**
     * @see FinancialTransactionService#findBySearchFormPageable(Integer,
     * Category, Area, String, String, Organization, String, Pageable)
     * @param year
     * @param sector
     * @param recipient
     * @param searchString
    ...
    /**
     * @see CustomFinancialTransactionService#findByDonorIdCrsIdActive(String,
     * String, Boolean, String, Pageable)
     * @param crsIdSearch
     * @param donorIdSearch
     * @param locale
     * @param pageable
    ...
    /**
     * @see
     * CustomFinancialTransactionService#findByDraftAndPersistedUserGroupPageable(Boolean,
     * PersistedUserGroup, Pageable)
     * @param draft
    ...
    /**
     * @see CustomFinancialTransactionService#findByDraftPageable(Boolean,
     * Pageable)
     * @param draft
     * @param pageable
     * @return
    ...
    /**
     * @see CustomFinancialTransactionService#findByApprovedPageable(Boolean,
     * Pageable)
     * @param draft
     * @param pageable
     * @return
    ...
    /**
     * @see
     * CustomFinancialTransactionService#findByApprovedAndPersistedUserGroupPageable(Boolean,
     * PersistedUserGroup, Pageable)
     * @param approved
     * @param persistedUserGroup
     * @param pageable
    ...
    /**
     * @see
     * CustomFinancialTransactionService#findByReportingYearAndDraftFalse(Integer)
     * @param year
     * @return
     */
    ...
    /**
     * @see
     * CustomFinancialTransactionService#findByReportingYearAndDraftFalseAndFormTypeNotIn(Integer)
     * @param year
     * @return
     */
    ...
    /**
     * @see
     * CustomFinancialTransactionService#findByReportingYearAndDraftFalseAndFormTypeIn(Integer)
     * @param year
     * @return
     */
