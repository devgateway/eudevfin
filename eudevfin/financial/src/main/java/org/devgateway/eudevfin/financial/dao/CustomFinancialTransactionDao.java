...
import org.devgateway.eudevfin.financial.CustomFinancialTransaction_;
...
public class CustomFinancialTransactionDao
	...
	public static Specification<CustomFinancialTransaction> whereClauseDesktopSearch(final LocalDateTime year, final Category sector,
		   ...
		   MapJoin<CustomFinancialTransaction,String,FinancialTransactionTranslation> join = root.join(CustomFinancialTransaction_.translations);
	...
	public Page<CustomFinancialTransaction> findBySearchFormPageable(
		...
		return this.getRepo().findAll(
				whereClauseDesktopSearch(year, sector, recipient, searchString, formType, extendingAgency), pageable);
	}
